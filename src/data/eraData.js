export const ERA_DATA = {
  modern: {
    ...
    groups: {
      "nato & allies": { color: "#4a6fa5", opacity: 0.55, countries: ["United States of America","Canada","United Kingdom","France","Germany","Italy","Spain","Australia","Japan","South Korea","Poland","Netherlands","Belgium","Denmark","Norway","Sweden","Finland","Portugal","Greece","Turkey","Czechia","Hungary","Slovakia","Romania","Bulgaria","Croatia","Albania","Montenegro","North Macedonia","Estonia","Latvia","Lithuania","Slovenia","Luxembourg","Iceland","New Zealand","Malta","Cyprus","Kosovo","Israel","Taiwan","Singapore","Andorra","Liechtenstein","Monaco","San Marino","Greenland","Puerto Rico"] },
      "brics & partners": { color: "#b5451b", opacity: 0.55, countries: ["China","Russia","India","Brazil","South Africa","Egypt","Ethiopia","Iran","United Arab Emirates","Saudi Arabia","Argentina","Indonesia","North Korea","Belarus","Syria","Cuba","Venezuela","Nicaragua","Baykonur Cosmodrome"] },
      "nonaligned": { color: "#5a8a5a", opacity: 0.45, countries: ["Mexico","Nigeria","Pakistan","Bangladesh","Vietnam","Philippines","Malaysia","Thailand","Colombia","Kenya","United Republic of Tanzania","Ghana","Morocco","Algeria","Tunisia","Libya","Uganda","Cameroon","Angola","Mozambique","Zimbabwe","Zambia","Senegal","Ivory Coast","Peru","Chile","Bolivia","Ecuador","Myanmar","Sri Lanka","Nepal","Jordan","Lebanon","Iraq","Ukraine","Moldova","Republic of Serbia","Bosnia and Herzegovina","Qatar","Kuwait","Oman","Bahrain","Brunei","Trinidad and Tobago","Guyana","Suriname","The Bahamas","Barbados","Jamaica","Dominican Republic","Haiti","Namibia","Botswana","Madagascar","Malawi","Rwanda","Burundi","Sudan","South Sudan","Somalia","Djibouti","Eritrea","Mali","Niger","Chad","Burkina Faso","Benin","Togo","Guinea","Guinea-Bissau","Sierra Leone","Liberia","Gambia","Mauritania","Gabon","Republic of the Congo","Democratic Republic of the Congo","Central African Republic","Equatorial Guinea","eSwatini","Lesotho","Cabo Verde","Comoros","Mauritius","Seychelles","São Tomé and Principe","Maldives","East Timor","Palestine","Yemen","Western Sahara","Somaliland"] },
      "neutral & pacific": { color: "#8a6a4a", opacity: 0.4, countries: ["Switzerland","Austria","Ireland","Kazakhstan","Uzbekistan","Turkmenistan","Azerbaijan","Georgia","Armenia","Mongolia","Cambodia","Laos","Bhutan","Tajikistan","Kyrgyzstan","Afghanistan","Paraguay","Uruguay","Panama","Costa Rica","Guatemala","Honduras","El Salvador","Papua New Guinea","Fiji","Samoa","Tonga","Vanuatu","Solomon Islands","Kiribati","Tuvalu","Nauru","Palau","Marshall Islands","Federated States of Micronesia","Belize","Dominica","Grenada","Antigua and Barbuda","Vatican"] },
    }
  },
  coldwar: {
    label: "Cold War Era",
